                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./role_add.php" target="_self">Role Add</a></li>
                            <li><a href="./role_show.php" target="_self">Role Show</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-single-04"></i><span class="nav-text">User</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./user_add.php" target="_self">User Add</a></li>
                            <li><a href="./user_show.php" target="_self">User Show</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-single-04"></i><span class="nav-text">Category</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./category_add.php" target="_self">Category Add</a></li>
                            <li><a href="./category_show.php" target="_self">Category Show</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
